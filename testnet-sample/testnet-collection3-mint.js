...
// load contract address and deploy nft collection
async function loadContract() {
  ...
  tomaasNFT = await TomaasNFT.deploy("TomaasNFT #3", process.env.USDC_ETH_ADDRESS);
...
async function main() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    try {
      ...
      let fileName = `tomaas-collection3-nft${i}.json` 
